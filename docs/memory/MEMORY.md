...
| [project_vision_enrichment.md](project_vision_enrichment.md) | scripts/vision_enrich.py is archived — enrichment happens inline via api/enrich.js when items are captured (Apr 2026) |
