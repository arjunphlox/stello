...
| Entry | Summary |
|---|---|
| [project_native_apple_app.md](project_native_apple_app.md) | Native SwiftUI app under apple/Stello — local-first SwiftData+CloudKit, on-device AFM enrichment, XcodeGen harness, macOS inset-glass header (Sketch pattern), seed dedupe + broken-shell ItemImage gotchas; coexists with web (Jun 2026) |
